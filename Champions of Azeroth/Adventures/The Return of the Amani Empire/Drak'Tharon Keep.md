...
___
> ## Novos the Summoner <!-- https://wc5e-cr-calculator.frogvall.com/?v3;1;1;17;16d8+16*3;9;17;10+1d6*1d10+0.5*2*1d6+3*4d6;10+1d6*1d10+0.5*2*1d6+3*4d6;10+1d6*1d10+0.5*2*1d6+3*4d6;0;0;0;;;;1;2;;;;;;;;;;1;1;;;;;;;1;;;;;;;2;2;1;3;0;1;1;3;;is1;;is2;;is3; -->
...
> STR | DEX | CON | INT | WIS | CHA
>|:---:|:---:|:---:|:---:|:---:|:---:|
> 8 (-1)|12 (+1)|16 (+3)|21 (+5)|16 (+3)|15 (+2)|
> ___
> - **Saving Throws** Con +7, Wis +7
> - **Skills**  Arcana +16, History +9, Insight +7, <br>Perception +7
...
>
> ***Undead Nature.*** Novos doesn’t require air, food, drink, or sleep. Magic can't put Novos to sleep.
>
> ### Actions
> ***Blizzard (recharge 5-6).*** A hail of rock-hard ice pounds to the ground in a 20-foot-radius, 40-foot-high cylinder centered on a point within 300 ft. Each creature in the cylinder must make a DC 17 Dexterity saving throw. A creature takes 2d8 bludgeoning damage and 4d6 cold damage on a failed save, or half as much damage on a successful one.
>
> ***Claws.*** Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 6 (2d4 + 1) slashing damage.
>
> ***Command.*** All *crystal handlers*, *hulking corpses* and *risen shadowcasters* that can hear Novos uses their reaction to move up to their speed and then make an attack.
>
> ***Frostbolt.*** Ranged Spell Attack: +9 to hit, reach 60 ft., one creature. Hit: 21 (6d6) cold damage and the target has its speed is reduced by 10 feet until the start of Novos next turn.
>
> ***Spellcasting.*** Novos casts one of the following spells, using Intelligence as the spellcasting ability (spell save DC 17):
>
...
>
> ### Bonus Actions
> ***Summon Minions.*** Novos summons 1d6 *risen shadowcasters* into empty spaces within 60 ft. of him. If this actions summons 3 or fewer *risen shadowcasters* a *hulking corpse* is also summoned into an empty space within 60 ft. of Novos. The summoned minions are controlled by Novos and don't roll for initiative, nor acts on their own.
>
> ### Legendary Actions
> Novos can take 3 legendary actions, choosing from the options below. Only one legendary action option can be used at a time only at the end of another creature's turn. Novos regains spent legendary actions at the start of its turn.
>
...
### Novos' Lair <!-- https://wc5e-cr-calculator.frogvall.com/?v3;1;2;17;16d8+16*3;9;17;10+2*(2d8+4d6)+3*4d6;10+1d6*1d10+0.5*2*1d6+2d8+3*4d6;10+1d6*1d10+0.5*2*1d6+2d8+3*4d6;0;0;0;;;;1;2;;;;;;;;;;1;1;;;;;;1;33;;;;;;;2;2;1;3;0;1;1;3;;is1;;is2;;is3; -->
On initiative count 20 (losing initiative ties), Novos takes a lair action to cause one the following effect:
...
___
___
> ## Devilsaur King <!-- https://wc5e-cr-calculator.frogvall.com/?v3;1;2;15;187;14;12;75+11;75+32;75+53;0;0;0;;;;;3;;;;;;;;;1;1;;;;;;;;10;;;;;;;;;;;1;0;1;3;;is1;;is2;;is3; -->
...
> <br> **Swallow (Costs 2 Actions).** The devilsaur king swallows <br>&nbsp;&nbsp;&nbsp; a creature it is grappling and the grapple ends.
